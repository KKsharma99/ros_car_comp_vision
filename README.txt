This folder contains the catkin workstation which contains the computer vision project for both object detection and image segmentation. (In the root, there is a ros videobag that can be used for testing ros nodes in the computer vision project) The computer vision project is named as "beginner tutorials". To find the main files go to "src/beginner_tutorials/scripts"
